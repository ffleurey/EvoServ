...
import eu.diversify.evoserv.model.SGHFeature;
import eu.diversify.evoserv.model.SGHServer;
import eu.diversify.evoserv.model.SGHVariationPoint;
import eu.diversify.evoserv.random.PoissonIntegerGenerator;
...
public class SGHModel {
    ...
    private Hashtable<String, SGHVariationPoint> createSGHVariationPoints() {
        ...
        SGHVariationPoint v = new SGHVariationPoint("vehicle", new PoissonIntegerGenerator(2), new PoissonIntegerGenerator(1), false, false);
        ...
        v = new SGHVariationPoint("algorithm", null, false, false);
        v.addAlternative(new SGHFeature("dijkstra", 200, v));
        v.addAlternative(new SGHFeature("astar", 20, v));
        result.put(v.getName(), v);
        
        v = new SGHVariationPoint("weighting", new PoissonIntegerGenerator(5), new PoissonIntegerGenerator(2), false, true);
