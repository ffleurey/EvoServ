...
import eu.diversify.evoserv.random.IntegerGenerator;
...
public class SGHVariationPoint {
    ...
    public Hashtable<String, SGHFeature> alternatives = new Hashtable<String, SGHFeature>();
    public IntegerGenerator serverMultGenerator = null;
    ...
    public SGHVariationPoint(String name, IntegerGenerator multiplicityGenerator, boolean optional, boolean isMultiple) {
        this.name = name;
    ...
    public SGHVariationPoint(String name, IntegerGenerator serverMultGenerator, IntegerGenerator clientMultGenerator, boolean optional, boolean isMultiple) {
        this.name = name;
